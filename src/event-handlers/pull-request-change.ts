...
const handlePullRequestChange = async (jiraClient: any, pr_title: string) => {
...
export const handlePullRequestChangeProbot = (context: any) => {
...
export const handlePullRequestChangeGithubAction = async (tools) => {
